...
$('#title').change(function() {
	...
	{
		var others = document.createElement("input");
		others.type = "text";
		others.id = "other-title";
		others.placeholder = "Your Job Role";
		list.parentNode.insertBefore(others, list.nextSibling);
	}
	else
	{
		if(list.nextSibling.id == "other-title")
		{
